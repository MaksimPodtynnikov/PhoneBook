...
public class DatabaseAdapter {
    ...
    private Cursor getAllEntries(){
        String[] columns = new String[] {DatabaseHelper.COLUMN_ID, DatabaseHelper.COLUMN_NAME,
                DatabaseHelper.COLUMN_FAMILY,DatabaseHelper.COLUMN_PATRONYMIC,DatabaseHelper.COLUMN_PHONE,DatabaseHelper.COLUMN_AVATAR};
    ...
    public ArrayList<Person> getPersons(){
        ...
        while (cursor.moveToNext()){
            ...
            @SuppressLint("Range") String family = cursor.getString(cursor.getColumnIndex(DatabaseHelper.COLUMN_FAMILY));
    ...
    public long insert(Person person){
        ...
        cv.put(DatabaseHelper.COLUMN_FAMILY, person.getFamily());
    ...
    public ArrayList<Person> search(String text)
    {
        ...
        Cursor cursor = database.rawQuery("select * from " + DatabaseHelper.TABLE + " where " +
                DatabaseHelper.COLUMN_NAME + " LIKE ? OR "+ DatabaseHelper.COLUMN_FAMILY+
